...
def get_prediction_raw_data(clean_data_file_path,
    ...
    merge = merge[["station_id", "lat", "lon", "altitude", "year", "month", "day",
...
if __name__ == "__main__":
    get_prediction_raw_data("cleaned_data.parquet",
                            "station_information.csv",
                            metadata_sample_submission_path="metadata_sample_submission.csv",
                            bank_holidays_bcn_path="bank_holidays_bcn.csv")